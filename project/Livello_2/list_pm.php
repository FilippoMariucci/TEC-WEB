...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Your messages <span class="badge"><font color="#ffcccc"><?php echo $nb_new_pm; ?></font></span></a> - <a href="profile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($_SESSION['valid'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="../Livello_1/login_1.php">Logout</a>)
    </div>
    <div class="clean"></div>
</div>
...
?>
	<tr>
    	...
    	<td><span class="glyphicon glyphicon-user"></span> <a href="profile.php?id=<?php echo $dn1['userid']; ?>"><?php echo ucfirst(htmlentities($dn1['username'], ENT_QUOTES, 'UTF-8')); ?></a></td>
...
?>
	<tr>
    	<td colspan="4" class="center">You have no unread messagegregregregreg.</td>
    </tr>
<?php
}
?>
...
?>
	<tr>
    	...
    	<td><span class="glyphicon glyphicon-user"></span> <a href="profile.php?id=<?php echo $dn2['userid']; ?>"><?php echo ucfirst(htmlentities($dn2['username'], ENT_QUOTES, 'UTF-8')); ?></a></td>
